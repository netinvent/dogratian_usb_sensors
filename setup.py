...
#  -*- coding: utf-8 -*-
#
# This file is part of dogratian_usb_sensors package


__intname__ = 'dogratian_usb_sensors.setup'
...
PACKAGE_NAME = 'dogratian_usb_sensors'
DESCRIPTION = 'Pythonic library for Dogratian USB sensors'
...
setuptools.setup(
    ...
    url='https://github.com/netinvent/dogratian_usb_sensors',
